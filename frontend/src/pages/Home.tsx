  ...
  return (
    <div className="min-h-screen w-full overflow-x-hidden flex flex-col items-center justify-start gap-6 pb-20 bg-gray-50">
      ...
      <section className="relative w-full h-max min-h-svh flex flex-col items-start justify-end gap-6 pt-80 pb-30 px-25 overflow-hidden">
        <img
          src="https://images.unsplash.com/photo-1521731978332-9e9e714bdd20?w=1600&q=80"
          alt="RPI Club Sports"
          className="absolute inset-0 z-0 w-full h-full object-cover pointer-events-none blur-xs brightness-90 contrast-100"
        />
      ...
      <section id="featured-teams" className="max-w-full mb-10 text-center py-10 px-14 scroll-mt-20">
        ...
        {loading ? (
          ...
          <section className="rounded-2xl bg-white p-10 text-center shadow-sm mt-10">
            <h2 className="text-2xl font-bold text-gray-900">Could not load clubs</h2>
